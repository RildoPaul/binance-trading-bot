...
class OrderStats extends React.Component {
  render() {
    ...
    return (
      <div className='order-stats-wrapper bg-pink-dark p-2 px-3 mb-2'>
        <div className='order-stat-wrapper'>
          <button
            type='button'
            className={`btn btn-span ${orderStats.numberOfBuyOpenOrders ? '' : 'btn-span-disabled'
              }`}
        ...
        <div className='order-stat-wrapper'>
          <button
            type='button'
            className={`btn btn-span ${orderStats.numberOfOpenTrades ? '' : 'btn-span-disabled'
              }`}
