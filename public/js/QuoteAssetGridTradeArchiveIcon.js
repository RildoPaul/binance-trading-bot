        ...
        <React.Fragment key={'quote-asset-grid-trade-row-' + row.key}>
          <tr>
            <td className={`text-center align-middle`}>
              {row.symbol}
              <br />
              <span className='fs-7' title={moment(row.archivedAt).format()}>
                {'Closed ' + moment(row.archivedAt).fromNow()}
              </span>
            </td>
            <td
              title={row.profit}
              className={`text-center align-middle ${row.profit > 0
                ? 'buy-colour'
                : row.profit < 0
                  ? 'sell-colour'
                  : ''
            ...
            <td
              ...
              className={`text-center align-middle ${row.totalBuyQuoteQty === 0 ? 'text-muted' : ''
                }`}>
            ...
            <td
              ...
              className={`text-center align-middle ${row.totalSellQuoteQty === 0
                ? 'text-muted'
      ...
      <div className='coin-info-quote-asset-grid-trade-archive-wrapper d-inline-block'>
        ...
        <Modal
          ...
          <Modal.Header closeButton className='pt-1 pb-1'>
            <Modal.Title>Closed Trades for {quoteAsset}</Modal.Title>
          </Modal.Header>
              ...
              <React.Fragment>
                  ...
                  <Card className='border-0 trade-stat-wrapper'>
                    <Card.Body className='p-2 text-center'>
                      ...
                      <Card.Text
                        ...
                        className={`${stats.totalBuyQuoteQty === 0 ? 'text-muted' : ''
                          }`}>
                  ...
                  <Card className='border-0 trade-stat-wrapper'>
                    <Card.Body className='p-2 text-center'>
                      ...
                      <Card.Text
                        ...
                        className={`${stats.totalSellQuoteQty === 0 ? 'text-muted' : ''
                          }`}>
                ...
                <div className='row mb-1'>
                  ...
                  <div className='col-sm-12 col-md-6 text-right'>
                    <button
                      type='button'
                      className={`btn btn-period ml-1 btn-sm ${period === 'd' ? 'btn-info' : 'btn-light'
                        }`}
                    ...
                    <button
                      type='button'
                      className={`btn btn-period ml-1 btn-sm ${period === 'w' ? 'btn-info' : 'btn-light'
                        }`}
                    ...
                    <button
                      type='button'
                      className={`btn btn-period ml-1 btn-sm ${period === 'm' ? 'btn-info' : 'btn-light'
                        }`}
                    ...
                    <button
                      type='button'
                      className={`btn btn-period ml-1 btn-sm ${period === 'a' ? 'btn-info' : 'btn-light'
                        }`}
