          ...
          <div className='coin-info-column-grid'>
            ...
            {buy.triggerPrice && currentGridTradeIndex === i ? (
              <div className='coin-info-column coin-info-column-price'>
                ...
                <HightlightChange
                  className={`coin-info-value ${symbolConfiguration.buy.athRestriction.enabled &&
                    parseFloat(buy.triggerPrice) >
                    parseFloat(buy.athRestrictionPrice)
                    ? 'text-warning'
                    : ''
            ...
            {buy.difference && currentGridTradeIndex === i ? (
              <div className='coin-info-column coin-info-column-price'>
                ...
                <HightlightChange
                  className={`coin-info-value ${buy.difference > 0
                    ? 'text-success'
                    : buy.difference < 0
                      ? 'text-danger'
                      : ''
      ...
      <div className='coin-info-sub-wrapper'>
        <div className='coin-info-column coin-info-column-title'>
          ...
          {symbolConfiguration.buy.enabled === false ? (
            <HightlightChange className='coin-info-message badge-pill badge-disabled'>
              Trading is disabled.
            </HightlightChange>
          ) : (
            ''
        ...
        <div className='coin-info-column coin-info-column-price mb-1'></div>
        {buyGridRows}
        {buyNextGrid()}
        {buy.processMessage ? (
          <div className='d-flex flex-column w-100'>
