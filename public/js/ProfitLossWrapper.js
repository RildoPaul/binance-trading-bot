        ...
        return (
          <div
            ...
            <div className='profit-loss-wrapper-body'>
              ...
              <div
                className={`profit-loss-value ${profitAndLoss.profit > 0
                  ? 'text-success'
              ...
              <Accordion.Toggle
                ...
                <div className='d-flex flex-row justify-content-between'>
                  ...
                  <div className='flex-column-right pt-2'>
                    <button
                      type='button'
                      className={`btn btn-period ml-1 btn-sm ${selectedPeriod === 'd' ? 'btn-filter-active' : 'btn-light'
                        }`}
                    ...
                    <button
                      type='button'
                      className={`btn btn-period ml-1 btn-sm ${selectedPeriod === 'w' ? 'btn-filter-active' : 'btn-light'
                        }`}
                    ...
                    <button
                      type='button'
                      className={`btn btn-period ml-1 btn-sm ${selectedPeriod === 'm' ? 'btn-filter-active' : 'btn-light'
                        }`}
                    ...
                    <button
                      type='button'
                      className={`btn btn-period ml-1 btn-sm ${selectedPeriod === 'a' ? 'btn-filter-active' : 'btn-light'
                        }`}
