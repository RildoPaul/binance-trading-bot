      ...
      <div className='coin-info-sub-wrapper coin-info-sub-wrapper-setting'>
        ...
        <div
          ...
          <div className='coin-info-sub-wrapper'>
            ...
            <div
              className={`coin-info-column coin-info-column-order ${this.warnIfAttributeCustomised('buy.enabled')
                  ? 'text-warning'
                  : ''
                }`}>
          ...
          <div className='coin-info-sub-wrapper'>
            ...
            <div
              className={`coin-info-column coin-info-column-order ${this.warnIfAttributeCustomised('sell.enabled')
                  ? 'text-warning'
                  : ''
                }`}>
              <span className='coin-info-label'>Trading enabled:</span>
